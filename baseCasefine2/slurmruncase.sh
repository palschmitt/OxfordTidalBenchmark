...
runApplication decomposePar -copyZero -noFunctionObjects
runParallel snappyHexMesh -overwrite -noFunctionObjects

runParallel createPatch -overwrite -noFunctionObjects


runParallel setFields 
runParallel topoSet -dict system/topoSetDict.fvOptions
touch case.foam
